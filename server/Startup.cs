  ...
  public partial class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddMvc(options =>
      {
          ...
          options.OutputFormatters.Add(new AzTest.Data.CsvDataContractSerializerOutputFormatter());
          options.OutputFormatters.Add(new AzTest.Data.XlsDataContractSerializerOutputFormatter());
