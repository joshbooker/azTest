...
export class SampleService {
  ...
  getOrders(filter: string | null, top: number | null, skip: number | null, orderby: string | null, expand: string | null, select: string | null, count: boolean | null) : Observable<any> {
    return this.odata.get(`/Orders`, { filter, top, skip, orderby, expand, select, count });
  }
  ...
  getOrderDetails(filter: string | null, top: number | null, skip: number | null, orderby: string | null, expand: string | null, select: string | null, count: boolean | null) : Observable<any> {
    return this.odata.get(`/OrderDetails`, { filter, top, skip, orderby, expand, select, count });
  }
  ...
  getProducts(filter: string | null, top: number | null, skip: number | null, orderby: string | null, expand: string | null, select: string | null, count: boolean | null) : Observable<any> {
    return this.odata.get(`/Products`, { filter, top, skip, orderby, expand, select, count });
  }
